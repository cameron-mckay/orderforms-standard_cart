                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hostname" class="form-control" id="inputHostname" value="{$server.hostname}" placeholder="servername.example.com" pattern="^[a-zA-Z0-9\-\.]*$" title="Valid hostname or FQDN">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
